...
export const profile = {
	update_successfully: "User profile updated successfully",
};
...
export const login_error = {
	...
	not_verified_message:
		"Your account has not verified yet. Please verify your account first",
	inactive_message:
		"Your account has been deactivated. Please contact to administrator and try again",
	deleted_message:
		"Your account has been deleted. Please contact to administrator and try again",
	blocked_message:
		"Your account has been blocked. Please contact to administrator and try again",
	role_assign:
		"You are not authorize to login. Please contact to administrator and try again",
...
export const master_validation = {
	...
	invalid_old_password:
		"Invalid old password. Please enter correct password and try again",
